...
const (
	...
	CoffeeShop_MakeCoffee_FullMethodName     = "/coffeeshop.CoffeeShop/MakeCoffee"
...
//
// Service CoffeeShop with the following methods:
type CoffeeShopClient interface {
	...
	MakeCoffee(ctx context.Context, in *CoffeeRequest, opts ...grpc.CallOption) (*Coffee, error)
...
func (c *coffeeShopClient) MakeCoffee(ctx context.Context, in *CoffeeRequest, opts ...grpc.CallOption) (*Coffee, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Coffee)
	err := c.cc.Invoke(ctx, CoffeeShop_MakeCoffee_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoffeeShopServer interface {
	...
	MakeCoffee(context.Context, *CoffeeRequest) (*Coffee, error)
...
func (UnimplementedCoffeeShopServer) MakeCoffee(context.Context, *CoffeeRequest) (*Coffee, error) {
	return nil, status.Error(codes.Unimplemented, "method MakeCoffee not implemented")
}
...
func _CoffeeShop_MakeCoffee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CoffeeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoffeeShopServer).MakeCoffee(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoffeeShop_MakeCoffee_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoffeeShopServer).MakeCoffee(ctx, req.(*CoffeeRequest))
	}
...
var CoffeeShop_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CoffeeShop_MakeCoffee_Handler,
		},
		{
	...
	Metadata: "proto/coffeeshop.proto",
}
